...
import com.kickhead.cameragallery.SharedPrefConstant


class SharedPreferencesManager private constructor(context: Context)  {
    private val preferences: SharedPreferences = context.getSharedPreferences(SharedPrefConstant.PREF_CREDENTIAL, Context.MODE_PRIVATE)
    companion object {
